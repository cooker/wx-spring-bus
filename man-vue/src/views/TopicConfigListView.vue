<template>
  <div class="topic-config-list">
    <a-card title="Topic 配置">
      <a-alert
        type="info"
        show-icon
      ...
      >
        ...
        <template #description>
          Topic 配置用于维护各事件主题的中文名称与说明，便于在事件列表、消费链路等页面展示友好名称。下表「说明」为每条配置的详细描述，悬停可查看完整内容。
        </template>
      </a-alert>
    ...
    >
      ...
      >
        ...
        <a-form-item label="中文名称 (nameZh)" name="nameZh">
          <a-input v-model:value="form.nameZh" placeholder="如：订单已购买" />
        </a-form-item>
...
const columns = [
  ...
  { title: '主题 (topic)', dataIndex: 'topic', key: 'topic', width: 180 },
  { title: '中文名称 (nameZh)', dataIndex: 'nameZh', key: 'nameZh', width: 140 },
